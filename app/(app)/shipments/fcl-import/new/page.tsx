...
export default async function NewFclImportShipmentPage({
  ...
  async function createShipmentAction(formData: FormData) {
    ...
    if (
      ...
      redirect("/shipments/fcl-import/new?error=invalid");
    }
    ...
    redirect(`/shipments/fcl-import/${created.shipmentId}`);
  }
      ...
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div>
          ...
          <p className="mt-2 max-w-2xl text-sm text-slate-600">
            Create shipments with a guided workflow, container intelligence, and
            an operations-ready timeline. This is a separate workspace from the
            classic shipment form.
          </p>
        </div>
        <Link
          href="/shipments"
